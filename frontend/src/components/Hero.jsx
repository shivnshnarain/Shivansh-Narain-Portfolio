...
export default function Hero({ setActiveView }) {
  ...
  const designerClip = isMobile 
    ? (mobileMode === 'designer' ? 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' : 'polygon(100% 0, 100% 0, 100% 100%, 100% 100%)')
    : `polygon(0 0, ${sliderPosition}% 0, ${sliderPosition}% 100%, 0 100%)`;

  const developerClip = isMobile
    ? (mobileMode === 'developer' ? 'polygon(0 0, 100% 0, 100% 100%, 0 100%)' : 'polygon(0 0, 0 0, 0 100%, 0 100%)')
